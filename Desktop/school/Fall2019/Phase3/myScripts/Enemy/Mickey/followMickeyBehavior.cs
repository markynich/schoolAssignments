 ...
 */
public class followMickeyBehavior : StateMachineBehaviour
{
    /*
     *  playerPos holds the position of the player
     *  flip is one of the control variables to control the turns of the character
     *  walkSpeed is a serialize field to modify the values within Unity Program
     */
    ...
    {
        if (Vector2.Distance(animator.transform.position, playerPos.position) < 2f)
        {
